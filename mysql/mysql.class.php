...
class Database
{
    ...
    private $db_host = DB_Config::DB_HOST;  // Database Host
    private $db_user = DB_Config::DB_USER;  // Username
    private $db_pass = DB_Config::DB_PASS;  // Password
    private $db_name = DB_Config::DB_NAME;  // Database
